@echo off
echo ========================================
echo   Deploying F2C to TEST
echo ========================================
echo.

echo Step 1: Building Flutter Web for Test...
cd /d "%~dp0.."
call flutter build web --release -t lib/main_test.dart
if %errorlevel% neq 0 (
    echo Build failed!
    exit /b %errorlevel%
)
...
echo.
echo Step 2: Deploying to Firebase Hosting (f2c-test)...
call firebase use f2c-test
