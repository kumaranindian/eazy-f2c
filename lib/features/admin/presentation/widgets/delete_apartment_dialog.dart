...
class DeleteApartmentDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DeleteApartmentDialog> createState() => _DeleteApartmentDialogState();
}
...
class _DeleteApartmentDialogState extends ConsumerState<DeleteApartmentDialog> {
  ...
  Future<void> _handleDelete() async {
    ...
    try {
      ...
      await repository.deleteApartment(
        widget.apartment.id,
        user.id,
        user.role,
      );
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${widget.apartment.hubName} • ${widget.apartment.location}',
                  style: TextStyle(
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'This will soft delete the apartment. It can be restored later if needed.',
                    style: TextStyle(
