...
class AddApartmentDialog extends ConsumerStatefulWidget {
  const AddApartmentDialog({super.key});

  @override
  ConsumerState<AddApartmentDialog> createState() => _AddApartmentDialogState();
}

class _AddApartmentDialogState extends ConsumerState<AddApartmentDialog> {
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      await repository.createApartment(apartment, user.id, user.role);
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    label: Text(_isLoading ? 'Creating...' : 'Create Apartment'),
