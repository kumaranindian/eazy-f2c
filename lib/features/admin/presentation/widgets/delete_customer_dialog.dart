...
class DeleteCustomerDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DeleteCustomerDialog> createState() => _DeleteCustomerDialogState();
}

class _DeleteCustomerDialogState extends ConsumerState<DeleteCustomerDialog> {
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'This will soft delete the customer. It can be restored later if needed.',
                    style: TextStyle(
