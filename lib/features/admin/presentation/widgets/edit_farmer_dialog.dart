...
class EditFarmerDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EditFarmerDialog> createState() => _EditFarmerDialogState();
}
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    label: Text(_isLoading ? 'Updating...' : 'Update Farmer'),
